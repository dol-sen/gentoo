...
RDEPEND="
	>=dev-python/xdis-3.2.4[${PYTHON_USEDEP}]
	<dev-python/xdis-3.3.0[${PYTHON_USEDEP}]
	>=dev-python/spark-parser-1.6.0[${PYTHON_USEDEP}]
	<dev-python/spark-parser-1.7.0[${PYTHON_USEDEP}]
"
DEPEND="${RDEPEND}
	test? (
